...
<div className="home-content">
 ...
 <div className="flex flex-col justify-center mt-6 lg:mt-20 items-center">
  <div className="content-container flex flex-col items-center justify-center ">
    ...
    <p className="subtitle mt-6 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110">
      <Link  href="https://s.salla.sa/marketplace/themes/147641223/preview">اشتري الان<span>→</span></Link>
    </p> 
  </div> 
